...
public class EnemyAttack : MonoBehaviour
{
    ...
    {
        while (Vector3.Distance(handObject.transform.position, Camera.main.transform.position) >= 1)
        { //If the distance between the camera and the hand is more than 1.-Tobias
